                ...
                if (isset($_GET['tipo'])) {
                    if ($_GET['tipo'] === 'prof') {
                        if (!isset($_GET['sala'])) {
                            ...
                            <p class="message-content"> Quagga: O PIN da sala atual é ' . $sala  . '</p>
                            </div>
                            <br>';
                        ...
                        if (isset($_GET['sala'])) {
                            ...
                            if ($salaExist === false) {
                                echo '<div class="message-blue">
                                        <p class="message-content"> Quagga: Algo de errado aconteceu, verifique com o professor o PIN da sala!</p>
                                      </div>
                                      <br>';
                            }
                            $sala = $_GET['sala'];
                ...
                <form action="redirectSala.php" method="post" class="mt-auto <?php echo ($salaExist === false) ? 'd-none' : ''; ?>">
                    <div class="row mt-auto fixed-bottom" style="padding-bottom: 1rem !important; padding-left:2rem">
                        ...
                        <div class="col-4 col-sm-1 col-md-1 col-lg-1 col-xl-1">
                            <button class="btn bg-material-blue text-center" style="color: white; padding-bottom: 0 !important;">
                                <btn class="material-symbols-outlined">send</btn>
                            </button>
                        </div>
                    </div>
